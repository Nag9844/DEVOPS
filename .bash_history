...
clear
exit
sudo apt yum remove docker docker-engine docker.io containerd runc
sudo yum remove docker docker-engine docker.io containerd runc
exit
apt-get update
yum update
clear
sudo apt-get install     ca-certificates     curl     gnupg sudo yum install     ca-certificates     curl     gnupg clear
